...
with(plotData, {
    plot(plotData$DateTime, plotData$Sub_metering_1, type="l", xlab="", ylab="Energe sub metering", col="black", ylim=range(0,50))
    ...
    legend("topright", pch="-",  col=c("black", "red", "blue"),legend=c("Sub_metering1", "Sub_metering_2", "Sub_metering_3"))
})
